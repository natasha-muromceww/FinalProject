...
ten_minutes_ago = datetime(the_datetime.year, the_datetime.month, the_datetime.day, the_datetime.hour, the_datetime.minute, the_datetime.second, the_datetime.microsecond)
